...
####Data####
load("www/data/datashiny_precariedad.RDATA")
metadata <- read_delim("www/data/Metadata_precariedad.csv", 
...
precariedad_ui <- function(id, title) {
  ns <- NS(id)
...
precariedad_server <- function(id) {
