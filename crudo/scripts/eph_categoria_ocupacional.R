...
eph_categoria_ocupacional <- readRDS("~/GitHub/ceped-data/opcion-modulos-paneles/www/data/eph_categoria_ocupacional.RDS") %>% 
  mutate(definicion="clasica")
...
saveRDS(eph_categoria_ocupacional, file = "opcion-modulos-paneles/www/data/eph_categoria_ocupacional.RDS")
