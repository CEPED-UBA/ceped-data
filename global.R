...
metadata_eph <- "Estimación del CEPED sobre datos de mercado de trabajo en base a la Encuesta Permanente de Hogares (EPH-INDEC). Los datos de 1995-2003 corresponden a la versión puntal de la EPH, mientras que el período 2003-actual corresponde a su versión continua. Estimaciones absolutas para 28 aglomerados urbanos. Beneficiarios del plan Jefes y Jegas de Hogar considerados como ocupados."
# Nota aclaratoria BP
