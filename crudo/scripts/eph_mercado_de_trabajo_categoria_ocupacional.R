...
saveRDS(base3,file = "data/eph_mercado_de_trabajo_categoria_ocupacional.RDS")
...
eph_mercado_de_trabajo_categoria_ocupacional <- readRDS(file = "data/eph_mercado_de_trabajo_categoria_ocupacional.RDS")

eph_mercado_de_trabajo_categoria_ocupacional <- rbind(eph_mercado_de_trabajo_categoria_ocupacional, base3)

saveRDS(eph_mercado_de_trabajo_categoria_ocupacional, file = "data/eph_mercado_de_trabajo_categoria_ocupacional.RDS")
